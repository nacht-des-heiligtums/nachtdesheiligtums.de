...
{% if site.datenschutz.google_anaylitcs %}
## Google Analytics
...
Sie können die Erfassung Ihrer Daten durch Google Analytics verhindern, verhindern, indem Sie auf folgenden Link klicken. Es wird ein Opt-Out-Cookie gesetzt, der die Erfassung Ihrer Daten bei zukünftigen Besuchen dieser Website verhindert: [Google Analytics deaktivieren](javascript:gaOptout();)
{% endif %}

{% if site.datenschutz.piwik %}
## Piwik
